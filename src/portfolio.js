...
const blogSection = {
  ...
  blogs: [
    {
      url: "https://medium.com/@arjun.anand1",
      title: "My Medium articles",
      description:
        "All writings on Medium"
    }
  ],
  display: true // Set false to hide this section, defaults to true
};
